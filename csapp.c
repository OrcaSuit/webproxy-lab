 ...
 *
 *     오류 시 반환 값: 
 *       -2는 getaddrinfo 오류에 대해
 *       -1은 다른 오류에 대해 errno 설정
 */
/* $begin open_clientfd */
/* open_clientfd 함수 시작 */
int open_clientfd(char *hostname, char *port) {
    ...
    Getaddrinfo(hostname, port, &hints, &listp); //Getaddrinfo 함수를 호출함으로써 listp 에 family, socktype, protocol 등 여러 정보를 받아올수 있다.
